...
namespace Forms
{
    public partial class ModalModificarComision : Form
    {
        public ModalModificarComision(int id,Comision comision)
        {
            InitializeComponent();
            _comision = comision;
        }
        ...
        private readonly Comision _comision;
        private async void ModalModificarComision_Load_1(object sender, EventArgs e)
        {
            ...
            TextBoxId.Text = _comision.Id.ToString();
            richTextBoxDescripcion.Text = _comision.Desc;
            txtAnioEsp.Text = _comision.Anio_especialidad.ToString();
        ...
        private async void buttonPut_Click(object sender, EventArgs e)
        {
            ...
            else
            {
                ...
                var response = await _httpClient.PostAsJsonAsync($"comisiones/{id}", comision);
